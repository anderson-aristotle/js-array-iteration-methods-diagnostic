...
const words = ['cat', 'bath', 'orange', 'top', 'bye', 'hi', 'extravagant']
...
// determine if all the words in the array contain the letter 'e'.
const doesEveryWordContainE = words.every(() => {
